...
from app.corpus.io import read_jsonl, write_json, write_jsonl
from app.corpus.process import process, verify, verify_raw
...
class CorpusTests(unittest.TestCase):
    def setUp(self):
        ...
        write_json(self.config, {"language": "pt-BR", "pages_per_slice": 3, "genres": [18],
            "periods": [[2000, 2010]], "vote_count_gte": 50, "sort_by": "popularity.desc",
            "include_adult": False, "request_interval_seconds": 0, "seed_movie_ids": []})
